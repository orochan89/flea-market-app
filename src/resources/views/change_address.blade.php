    ...
    <div class="change-address__container">
        ...
        <form class="change-address-form" action="{{ route('mailingAddress', ['item' => $item->id]) }}" method="post">
            ...
            <div class="change-address">
                ...
                <input class="form-input" type="text" name="postcode" value="{{ old('postcode') }}" id="postcode">
            </div>
            @error('postcode')
            ...
            <div class="change-address">
                ...
                <input class="form-input" type="text" name="address" value="{{ old('address') }}" id="address">
            </div>
            @error('address')
                <div class="alert">{{ $message }}</div>
            @enderror
            <div class="change-address">
                ...
                <input class="form-input" type="text" name="building" value="{{ old('building') }}" id="building">
            </div>
            @error('building')
                <div class="alert">{{ $message }}</div>
            @enderror
