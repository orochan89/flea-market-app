    ...
    <div class="header__inner">
        <div class="header-utilities">
            <a class="header__logo"
                href="{{ url('/') . '?' . http_build_query(['page' => request('page'), 'search' => request('search')]) }}">
            ...
            <div class="header-nav-container">
                ...
                @endguest
                <form class="header-nav__mypage"
                    action="{{ route('mypage', ['page' => 'sell', 'search' => request()->query('search')]) }} "
                    method="get">
